...
| **Manipulation et**  \ **visualisation de données**  | [**Démarche statistique et modèles linéaires avec R**](modelelineaire.html) | **Analyse de données** |  **Sensométrie** \ **avec R**|
|[**Machine learning avec R**](machinelearning.html) | | | |
